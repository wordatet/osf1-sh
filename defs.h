...
/* Compatibility shim for OSF/1 specifics */
#include "osf_sh_shims.h"
...
/* Prototype additions for portability */
extern void itos(int);
extern void initf(int);
extern void tdystak(uchar_t *);
extern void stakchk(void);
extern int growstak(void);
extern void rmtemp(uchar_t *);
extern int readc(void);
extern int execute(struct trenod *, int, int, int *, int *);
extern unsigned int readwc(int);
extern void unreadwc(unsigned int);
extern int trim(uchar_t *);
extern void assign(struct namnod *, uchar_t *);
extern void push(struct fileblk *);
extern int ignsig(int);
extern void specsigs(void);
extern void stdsigs(void);
extern void setup_env(void);
extern int sh_hcreate(void);
extern void set_dotpath(void);
extern int options(int, uchar_t **);
extern void done(void);
extern int chkmail(void);
extern int setmail(uchar_t *);
extern void alloc_free(void *);
extern void replace(uchar_t **, uchar_t *);
extern int assnum(uchar_t **, int);
extern void dfault(struct namnod *, uchar_t *);
extern int stoi(uchar_t *);
extern int pathopen(uchar_t *, uchar_t *);
extern int estabf(uchar_t *);
extern int chkopen(uchar_t *);
extern void exitsh(int);
extern void failed(uchar_t *, uchar_t *);
extern void error(uchar_t *);
extern uchar_t *setbrk(int);
extern int setsig(int);
extern int clrsig(int);
extern int pop(void);
extern int poptemp(void);
extern int execexp(uchar_t *, long);
extern void chkpr(void);
extern void prp(void);
extern void prn(int);
extern void prs_cntl(uchar_t *);
extern int word(void);
extern int skipc(void);
extern int syslook(uchar_t *, struct sysnod *, int);
extern int findpath(uchar_t *, int);
extern int prf(struct trenod *);
extern int chk_access(uchar_t *);
extern void prn_buff(int);
extern void prc_buff(int);
extern void prs_buff(uchar_t *);
extern int await(int, int);
extern int savefd(int);
extern int tmpfil(struct tempblk *);
extern int create(uchar_t *);
extern void sh_rename(int, int);
extern void clearup(void);
extern int setargs(uchar_t **);
extern int expand(uchar_t *, int);
extern void makearg(struct argnod *);
extern int NLpushstak(int);
extern int NLSencode(uchar_t *, uchar_t *, int);
extern int NLSdecode(uchar_t *);
extern int NLSdecodeargs(uchar_t **);
extern int NLSdecode1(uchar_t *, uchar_t *);
extern uchar_t *NLSndecode(uchar_t *);
extern int NLSfailed(uchar_t *, uchar_t *);
extern int NLany(uchar_t *, uchar_t *);
extern uchar_t *nextwc(void);
extern int NLSencode_stk(uchar_t *, int);
extern int nextc(int);
extern void copy(struct ionod *);
extern void chktrap(void);
extern void pushtemp(int, struct tempblk *);
...
extern int ldr_remove(uchar_t *);
extern void check_nls_and_locale(struct namnod *);
extern void resource(int, uchar_t **);
extern int test(int, uchar_t **);
extern int echo(int, uchar_t **);
extern void hashpr(void);
extern void unset_name(uchar_t *);
extern void restore(int);
extern void link_iodocs(struct ionod *);
extern void post(int);
extern void swap_iodoc_nm(struct ionod *);
extern void cwd(uchar_t *);
extern void cwdprint(void);
extern int readvar(uchar_t **);
...
extern void zaphash(void);
extern short hash_cmd(uchar_t *);
extern void what_is_path(uchar_t *);
extern void freefunc(struct namnod *);
extern void hash_func(uchar_t *);
extern short pathlook(uchar_t *, int, struct argnod *);
extern short hashtype(short);
extern short hashdata(short);
extern int getarg(struct comnod *);
extern uchar_t **scan(int);
extern int initio(struct ionod *, int);
extern uchar_t *catpath(uchar_t *, uchar_t *);
extern void zapcd(void);
extern void oldsigs(void);
extern int execa(uchar_t **, int);
extern void setlist(struct argnod *, int);
extern void execprint(uchar_t **);
extern void errormsg(char *, uchar_t *);
extern void flushb(void);
