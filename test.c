...
static int sh_exp(void);
static int sh_e1(void);
static int sh_e2(void);
static int sh_e3(void);
static int tio(uchar_t *, int);
static int ftype(uchar_t *, int);
static int filtyp(uchar_t *, int);
static int fsizep(uchar_t *);
static void bfailed(uchar_t *, uchar_t *, uchar_t *);
static uchar_t *nxtarg(int);
